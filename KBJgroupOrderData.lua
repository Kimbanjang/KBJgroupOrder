...
GroupOrderLegionNH = {
	...
	["Tichondrius"] = {
		[1] = {
			[1] = "[Carrion Plague] on Purple{다이아몬드} side / clean on Blue{네모} side",
			[2] = "Never dump [Brand of Argus] all together. just wait healup group",
	...
	["Krosus"] = {
		[1] = {
			[1] = "Group 1/3/5, [Burning Pitch] on Blue{네모} side",
			[2] = "Group 2/4/6, [Burning Pitch] on Orange{동그라미} side",
			[3] = "Prioritize killing [Burning Ember] when don't stand on pitch. THIS IS SO IMPORTANT!",
			[4] = "[Orb of Destruction] on Red{가위표} or Green{세모}. Check direction of [Fel Beam]",
			[5] = "Don't DIE from [Fel Beam] or break the bridge. NEVER!",
	...
	["Botanist"] = {
		[1] = {
			...
			[5] = "Prioritize killing [Parasitic Lasher]! THIS IS SO IMPORTANT!",
			[6] = "Stack on has [Call of Night] player if you are unmarked",
	...
	["StarAugur"] = {
		[1] = {
			...
			[3] = "Phase 1 : Everybody stack / Get away from the group when have debuff [Icy Ejection]",
			[4] = "Phase 2 : Everybody spread / Get away from the group when have debuff [Felflame]",
			[5] = "Phase 3 : Prioritize killing 1st big add and Just focus boss killed that",
			[6] = "Phase 3 : Turn away from the big add when it casts [Witness the Void] everytime",			
